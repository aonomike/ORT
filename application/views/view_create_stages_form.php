            	...
            	<div class="box">
                 ...
                 <div id="collapseOne" class="accordion-body collapse in body">
                                       <?php echo validation_errors()?>
                                            ...
                                            <?php
                                            $attributes = array('class' =>'form-horizontal', 'id'=>'block-validate','name'=>'create_stages' ,'method'=>'post' );
                                                echo form_open('Stage/create_stage',$attributes);
                                             ?> 
                                        <div class="form-group">
                                            <label for="description" class="control-label col-lg-4">Description</label>
                                            <div class="col-lg-4">
                                                <input type="text" maxlength="50" value="<?php echo set_value('description'); ?>" id="description" name="description" class="form-control"  required="required" />
                                            </div>
                                        </div> 
