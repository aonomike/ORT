            	...
            	<div class="box">
                 ...
                 <div id="collapseOne" class="accordion-body collapse in body">
                                       <?php echo validation_errors()?>
                                            ...
                                            <?php
                                            $attributes = array('class' =>'form-horizontal', 'id'=>'block-validate','name'=>'create_user_type' ,'method'=>'post' );
                                                echo form_open('User_type_controller/create_user_type',$attributes);
                                             ?> 
                                        <div class="form-group">
                                            <label for="description" class="control-label col-lg-4">User Type</label>
                                            <div class="col-lg-4">
