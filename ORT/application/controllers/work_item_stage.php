...
class Work_item_stage extends CI_Controller
{
	...
	public function list_work_item_stage()
	{
		if ($this->check_login()) {
			return ;
		}
	...
	public function create_work_item_stage(){
		if ($this->check_login()) {
			return ;
		}
		else
	...
	public function get_work_item_stage_by_work_item_id()
	{
		$id=$this->input->post('values');
		$work_item_stage=$this->work_item_stage_model->get_work_item_stage_by_work_item_id($id);
		echo json_encode($work_item_stage);
	}
	...
	{
		$id=$this->input->post('values');
		$work_item_stage=$this->work_item_stage_model->get_stages_by_work_item_stage($id);
		echo json_encode($work_item_stage);
	}
