                ...
                <div id="collapseOne" class="accordion-body collapse in body">
                                       <?php echo validation_errors()?>          
                                            <?php
                                                ...
                                                echo form_open('Work_item_author/update_work_item_author',$attributes);
                                             ?> 
                                         
                                        <div class="form-group">                                            
                                            <input type="hidden" id="work-item-author-id" name="work-item-author-id" value="<?php echo $work_item_author_id ?>" class="form-control" required="required"/>
                                        </div>
                                        <div class="form-group">                                            
                                            <input type="hidden" id="work-item-id" name="work-item-id" value="<?php echo $work_item_author->work_item_id ?>" class="form-control" required="required"/>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <select id="author" name="author" class="form-control" required="required">
                                                    ...
                                                    <?php foreach ($authors as $author):  ?> 
                                                        <option value="<?php echo $author->author_id ?>" 
                                                            <?php 
                                                                if (isset($work_item_author))
                                                                {
                                                                    if($author->author_id==$work_item_author->author_id)
                                                                    {
                                                            ...
                                                            ?>
                                                        >
                                                        <?php echo $author->first_name.' '.$author->second_name ?></option> 
                                                    <?php endforeach; ?> 
                                                </select>
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-4">
                                                <select id="author-type" name="author-type" class="form-control" required="required">
                                                    ...
                                                    <?php foreach ($author_types as $author_type):  ?> 
                                                        <option value="<?php echo $author_type->author_type_id ?>" 
                                                            <?php 
                                                                if (isset($work_item_author))
                                                                {
                                                                    if($author_type->author_type_id==$work_item_author->author_type)
                                                                    {
                                                                        echo 'selected="selected"';
                                                                    }
                                                                }
                                                            ?>
                                                        >
                                                        <?php echo $author_type->descriptions ?>
                                                        </option> 
                                                    <?php endforeach; ?> 
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="organisation" value="<?php echo $work_item_author->organisation?>" name="organisation" class="form-control" required="required">
                                            </div>  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="designation" value="<?php echo $work_item_author->designation?>" name="designation" class="form-control" required="required">
                                            </div>  
                                                                                                
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-4" for="country-select">Country</label>
                                            <div class="col-lg-4">
                                                <select id="country-select" name="country-select" class="form-control" required="required">
                                                    <option></option>
                                                    <?php foreach ($countries as $country):  ?> 
                                                        <option value="<?php echo $country->id ?>" 
                                                            <?php 
                                                                if (isset($work_item_author))
                                                                {
                                                                    if($country->id==$work_item_author->country_id)
                                                                    {
                                                                        echo 'selected="selected"';
                                                                    }
                                                                }
